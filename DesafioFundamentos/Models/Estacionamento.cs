namespace DesafioFundamentos.Models
{
    public class Estacionamento
    {
        ...
        public void RemoverVeiculo()
        {
            ...
            // IMPLEMENTADO:Pede para o usuário digitar a placa e armazenar na variável placa
            string placa = Console.ReadLine();

            // IMPLEMENTADO: Verifica se o veículo existe
        ...
        {
            // IMPLEMENTADO: Verifica se há veículos no estacionamento
            if (veiculos.Any())
            {
